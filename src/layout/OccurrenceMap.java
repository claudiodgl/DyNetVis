 ...
 */
public class OccurrenceMap implements Comparable{
    private Integer id;
    private Integer occurrence;

    public OccurrenceMap(Integer id,Integer occurrence){
        this.id = id;
    ...
    public int compareTo(Object o) {
        OccurrenceMap oc = (OccurrenceMap) o;
        if (this.occurrence > oc.getOccurrence()) {
             return -1;  
        }  
        if (this.occurrence < oc.getOccurrence()) {  
             return 1;  
