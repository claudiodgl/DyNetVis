...
public class Main {
   ...
   //    ArrayList<Integer> array = new ArrayList(Arrays.asList(64, 17, 16, 4, 6, 13, 15, 16, 4, 14, 42, 18, 18, 18));
    
     //   TemporalBarabasiAlbertModel t = new TemporalBarabasiAlbertModel(100, 3, 2);
     //   String teste = t.Execute();
