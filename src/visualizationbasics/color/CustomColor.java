 ...
 * @author Claudio
 */
public class CustomColor extends FromXToY {
    public CustomColor(Color inicial_c, Color final_c) {
        super(new int[]{inicial_c.getRed(),inicial_c.getGreen(),inicial_c.getBlue()}, new int[]{final_c.getRed(),final_c.getGreen(),final_c.getBlue()});
    }
}
